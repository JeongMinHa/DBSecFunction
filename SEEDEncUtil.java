 ...
 */
public class SEEDEncUtil {
	
	public static void main(String[] args){
		encValReturn(args[0]);
	}
	
	public static String encValReturn(String sEncValue){
		
		String rtrnValue = null;
		
		try{
			int[] seedKey = SEEDEncUtil.getSeedRoundKey("*************");
			
			rtrnValue = SEEDEncUtil.getEncrypt(sEncValue , seedKey);
	...
	public static String getEncrypt(String sPlainValue, int[] iSeedRoundKey) throws Exception {
		...
		for (int i = 0; i < plainByteLists.size(); i++) {
			...
			tempEncVal = SEEDEncUtil.SeedEncrypt(byteVal, iSeedRoundKey, tempEncVal);
	...
	public static String getDecrypt(String sEncValue, int[] iSeedRoundKey) throws Exception {
		...
		for(int i=0; i < encByteLists.size(); i++){
			...
			tempDecByte = SEEDEncUtil.SeedDecrypt(encByte, iSeedRoundKey, tempDecByte);
	...
	public static int[] getSeedRoundKey(String keyStr) throws Exception {
		...
		SEEDEncUtil.SeedRoundKey(seedKey, keyStr.getBytes());
